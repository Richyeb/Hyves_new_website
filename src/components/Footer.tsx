        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-12 mb-16">
          <div className="col-span-1">
            ...
            <div className="flex flex-col gap-3">
              <a href="https://apps.apple.com/us/app/hyves-corp/id6756138773" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-hyves-black text-white px-4 py-2 rounded-lg hover:bg-slate-800 transition-colors w-fit">
              ...
              <a href="https://play.google.com/store/apps/details?id=com.hyves.hyves" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-hyves-black text-white px-4 py-2 rounded-lg hover:bg-slate-800 transition-colors w-fit">
                <div className="w-5 h-5">
